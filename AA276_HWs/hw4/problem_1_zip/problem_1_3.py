...
class Controller:
    ...
    def query_value_function(self, s):
        """
        Use this to query the value function at the current state.
        This is purely to help you debug, in case you find it helpful.
        ...
        Returns:
            value (float): The value function
        """
    ...
    def smooth_blending_safety_filter(self, state, u_nom, gamma, lmbda):
